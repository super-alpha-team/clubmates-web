...
function ActivityItem(props: ActivityProps) {
  ...
  return (
    <div className="w-72 h-96 relative flex justify-center cursor-pointer group">
      ...
      <div className="w-60 absolute flex flex-col items-center justify-evenly p-4 bottom-0 bg-white rounded-xl shadow-md text-xs transition transform group-hover:-translate-y-4">
